      ...
      <main className="container mx-auto px-6 py-8">
        ...
        <div className="max-w-2xl mx-auto">
          {!user.subscription_active && (
            <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-700 rounded-lg p-4 mb-6 flex items-center justify-between">
              <div>
                <p className="font-semibold text-purple-800 dark:text-purple-300">Pro subscription required</p>
                <p className="text-sm text-purple-600 dark:text-purple-400">Subscribe to generate unlimited AI fitness plans.</p>
              </div>
              <button
                onClick={() => {
                  sessionStorage.setItem('paymentReturnTo', '/generate');
          ...
          <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-8 border border-gray-200 dark:border-slate-700 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white dark:bg-slate-700 text-gray-900 dark:text-white ${
            ...
            {/* BMI Display */}
            {bmiResult && (
              <div className="bg-gradient-to-r from-purple-50 dark:from-purple-900/20 to-purple-100 dark:to-purple-800/20 border border-purple-200 dark:border-purple-700 rounded-lg p-4 mb-8">
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Your Estimated Metrics:</p>
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">BMI: {bmiResult.bmi}</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">{bmiResult.category}</p>
                  </div>
                  {tdee && (
                    <div className="text-right">
                      <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">TDEE: {tdee}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="form-group md:col-span-2">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white dark:bg-slate-700 text-gray-900 dark:text-white ${
                    errors.activity_level ? 'border-red-500' : 'border-gray-300 dark:border-slate-600'
                  }`}
                >
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white dark:bg-slate-700 text-gray-900 dark:text-white ${
                    errors.fitness_goal ? 'border-red-500' : 'border-gray-300 dark:border-slate-600'
                  }`}
                >
