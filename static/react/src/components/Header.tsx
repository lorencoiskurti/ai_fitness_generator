...
export const Header = () => {
  ...
  return (
    <>
      <header className="bg-white/85 backdrop-blur-sm border-b border-gray-200 sticky top-0 z-50">
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <Link to="/" className="flex items-center space-x-2 sm:space-x-3">
                ...
                <span className="hidden sm:inline text-lg sm:text-xl font-bold text-gray-800">AI Fitness Generator</span>
              </Link>
            </div>
            <div className="hidden md:flex md:items-center md:space-x-4">
              {!user.authenticated ? (
                <>
                  ...
                  <Link
                    to="/register"
                    className="inline-flex items-center px-4 py-2 rounded-lg text-white bg-purple-600 hover:bg-purple-700 transition-colors font-medium shadow-lg hover:shadow-xl"
                  >
                    Sign Up
                  </Link>
                </>
                ...
                <>
                  ...
                  {user.subscription_active ? (
                    ...
                    <button
                      ...
                      className="inline-flex items-center px-3 py-1.5 rounded-lg text-purple-600 border border-purple-300 hover:bg-purple-50 transition-colors text-sm font-medium"
                    >
                      Go Pro
                    </button>
                  )}
                  <button
                    ...
                    className="inline-flex items-center px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-100 transition-colors font-medium"
                  >
                    Logout
                  </button>
                </>
